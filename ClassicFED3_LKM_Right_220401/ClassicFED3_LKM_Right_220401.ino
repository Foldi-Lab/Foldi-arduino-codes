/*
  ...
  // 2 FR3 (reversed)
  // 3 FR5 (reversed)
  // 4 Progressive Ratio (rev)
  // 5 Extinction (rev)
  // 6 Closed Economy PR (rev)
  // 7 Closed Economy PR1 (rev)
...
void loop() {
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //                                                                     Modes 1-3: Reversed Fixed Ratio Programs FR1, FR3, FR5
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

  if ((fed3.FEDmode == 1) or (fed3.FEDmode == 2) or (fed3.FEDmode == 3)) {
    if (fed3.FEDmode == 1) fed3.sessiontype = "FR1 (reversed)";    //The text in "sessiontype" will appear on the screen and in the logfile
    if (fed3.FEDmode == 2) fed3.sessiontype = "FR3 (reversed)";    //The text in "sessiontype" will appear on the screen and in the logfile
    if (fed3.FEDmode == 3) fed3.sessiontype = "FR5 (reversed)";    //The text in "sessiontype" will appear on the screen and in the logfile
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //                                                                     Mode 4: Progressive Ratio (reversed)
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  if (fed3.FEDmode == 4) {
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  if (fed3.FEDmode == 5) {
    fed3.sessiontype = "Ext (rev)";                        //The text in "sessiontype" will appear on the screen and in the logfile
    fed3.activePoke = 0;                                //Right poke is active
    if (fed3.Right) {
      fed3.logRightPoke();                                //Log Right poke
      fed3.ConditionedStimulus();                        //deliver conditioned stimulus (tone and lights)
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //                                                                     Mode 6: Closed Economy PR
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  if (fed3.FEDmode == 6) {
    fed3.sessiontype = "CEPR(rev)";
    ...
    if (fed3.Right) {                                     //If right poke is triggered
      ...
      if (poke_num == pokes_required) {                  //check if current FR has been achieved
        ...
        pokes_required = round((5 * exp((fed3.BlockPelletCount + 1) * 0.2)) - 5);  //Edit this line to change the PR incremementing formula.  Standard PR formula.
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //                                                                     Mode 7: Closed Economy PR1
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  if (fed3.FEDmode == 7) {
    fed3.sessiontype = "CEPR1(rev)";
    checkReset();                                        //Check if it's time to reset to FR1
    fed3.activePoke = 0;                                //Right poke is active
    if (fed3.Right) {                                     //If right poke is triggered
      fed3.logRightPoke();                                //log Right poke
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //                                                                     If a mode greater than 7 is selected
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  if (fed3.FEDmode > 7) {
