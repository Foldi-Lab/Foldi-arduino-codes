...
void FED3::SelectMode() {
  ...
  if (ClassicFED3==true){
    ...
    if (FEDmode == 1) display.print("Timed feeding");
    if (FEDmode == 2) display.print("FR1");
    if (FEDmode == 3) display.print("Progressive Ratio");
    if (FEDmode == 4) display.print("FR1 reversed");
    if (FEDmode == 5) display.print("PR reversed");
    if (FEDmode == 6) display.print("FR1 (both)");
    if (FEDmode == 7) display.print("Reversal Task");
    display.refresh();
  }
...
void FED3::ClassicMenu () {
  ...
  if (FEDmode == 2) FR = 1;  // FR1 
  if (FEDmode == 3) FR = 99; // Progressive Ratio
  if (FEDmode == 4) FR = 1; // FR1 (reversed)
  if (FEDmode == 5) FR = 99;  // Progressive Ratio (reversed)
  if (FEDmode == 6) FR = 1;  // FR1 (both)
  if (FEDmode == 7) FR = 1; // Reversal Task
