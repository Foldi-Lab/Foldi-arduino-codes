...
void FED3::SelectMode() {
  ...
  if (ClassicFED3==true){
    ...
    if (FEDmode == 6) display.print("Closed Econ PR");
    if (FEDmode == 7) display.print("Closed Econ PR1");
    display.refresh();
  }
...
void FED3::ClassicMenu () {
  ...
  if (FEDmode == 6) FR = 99;  // Closed Economy PR
  if (FEDmode == 7) FR = 99; // Closed Economy PR1
