...
void FED3::SelectMode() {
  ...
  if (ClassicFED3==true){
    ...
    if (FEDmode == 3) display.print("FR3");
    if (FEDmode == 4) display.print("FR5");
    if (FEDmode == 5) display.print("Extinction");
    if (FEDmode == 6) display.print("FR1 reversed");
    if (FEDmode == 7) display.print("FR3 reversed");
    if (FEDmode == 8) display.print("FR5 reversed");
    display.refresh();
  }
...
void FED3::ClassicMenu () {
  ...
  if (FEDmode == 3) FR = 3;  // FR3
  if (FEDmode == 4) FR = 5; // FR5
  ...
  if (FEDmode == 6) FR = 1;  // FR1 (reversed)
  if (FEDmode == 7) FR = 3; // FR3 (reversed)
  if (FEDmode == 8) FR = 5; // FR5 (reversed)
