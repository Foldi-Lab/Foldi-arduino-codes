...
void FED3::FED3MenuScreen() {
  ...
  if (FEDmode == 0) display.print("FR1 reversed");
  if (FEDmode == 1) display.print("FR1");
  if (FEDmode == 2) display.print("Reversal Task");
  if (FEDmode == 3) display.print("FR1 both");
...
void FED3::SelectMode() {
  ...
  //Otherwise we don't know them and just use Mode 1 through Mode 4
    ...
    if (FEDmode == 0) display.print("FR1 reversed");
    if (FEDmode == 1) display.print("FR1");
    if (FEDmode == 2) display.print("Prob Rev Task");
    if (FEDmode == 3) display.print("FR1 both");
    display.refresh();
  }
