...
void FED3::FED3MenuScreen() {
  ...
  if (FEDmode == 2) display.print("RR5");
  if (FEDmode == 3) display.print("RR10");
  if (FEDmode == 4) display.print("RR20");
...
void FED3::SelectMode() {
  ...
  //If Right Poke is activated
    ...
    colorWipe(strip.Color(0, 0, 0), 20); // OFF
    if (FEDmode == 6) FEDmode = 0;
  }

  if (FEDmode < 0) FEDmode = 0;
  if (FEDmode > 5) FEDmode = 5;
  ...
  if (ClassicFED3==true){
    if (FEDmode == 0) display.print("Free feeding");
    if (FEDmode == 1) display.print("FR1");
    if (FEDmode == 2) display.print("RandRatio5");
    if (FEDmode == 3) display.print("RandRatio10");
    if (FEDmode == 4) display.print("RandRatio20");
    if (FEDmode == 5) display.print("Extinction");
    display.refresh();
  }
...
void FED3::ClassicMenu () {
  ...
  if (FEDmode == 2) FR = (1, 6);  // RR5
  if (FEDmode == 3) FR = (1, 11); // RR10
  if (FEDmode == 4) FR = (1, 21); // RR20
  ...
  if (FEDmode == 0) display.print("Free feeding");
  if (FEDmode == 1) display.print("FR1");
  if (FEDmode == 2) display.print("RandRatio 5");
  if (FEDmode == 3) display.print("RandRatio 10");
  if (FEDmode == 4) display.print("RandRatio 20");
  if (FEDmode == 5) display.print("Extinction");
