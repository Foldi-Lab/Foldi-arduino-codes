...
void UpdateDisplay() {
  ...
  if (FEDmode == 12) {
    display.setCursor(5, 36);
    display.print("FR3 (reversed)");
  }
  
  if (FEDmode == 13) {
    display.setCursor(5, 36);
    display.print("FR5 (reversed)");
  }
  
  if (FEDmode == 14) {
    display.setCursor(5, 36);
    display.print("FR1 (both)");
  }
  ...
  ********************************************************/
  ...
  if (FEDmode > 0 & FEDmode != 11) {
    ...
    if (FEDmode == 7 || FEDmode == 8 || FEDmode == 10 || FEDmode == 12 || FEDmode == 13) {
      activePoke = 0;
    }
...
void DisplaySDError() {
  ...
  while (true) {
    ...
    colorWipe(strip.Color(2, 0, 0), 80); // Color wipe
...
void StartUpDisplay () {
  ...
  if (FEDmode == 12) FR = 3; // FR3 (reversed)
  if (FEDmode == 13) FR = 5; // FR5 (reversed)
  if (FEDmode == 14) FR = 1; // FR1 (both)
  ...
  if (FEDmode == 1 ||  FEDmode == 2 || FEDmode == 3 || FEDmode == 14) {
  ...
  if (FEDmode == 7 || FEDmode == 14) display.print("FR1");
  ...
  if (FEDmode == 8 || FEDmode == 7 || FEDmode == 10 || FEDmode == 12 || FEDmode == 13) display.setCursor(10, 65);
  if (FEDmode == 8 || FEDmode == 7 || FEDmode == 10 || FEDmode == 12 || FEDmode == 13) display.print("(reversed)");
  if (FEDmode == 14) display.setCursor(10, 65);
  if (FEDmode == 14) display.print("(both)");
