...
void SelectMode() {
  ...
  if (FEDmode == 1 || FEDmode == 7 || FEDmode == 14) FR = 1; // FR1 spatial task
  if (FEDmode == 2 || FEDmode == 12) FR = 3;  // FR3
  if (FEDmode == 3 || FEDmode == 13) FR = 5; // FR5
  ...
  //Set FEDMode
    ...
    colorWipe(strip.Color(0, 0, 0), 20); // OFF
    if (FEDmode == 15) FEDmode = 0;
  }

  if (FEDmode < 0) FEDmode = 0;
  if (FEDmode > 14) FEDmode = 14;
  ...
  if (FEDmode == 12) display.print("FR3");
  if (FEDmode == 13) display.print("FR5");
