...
int FR1to20 = random(1, 21);  //1 to 20
int FR1to10 = random(1, 11);  //1 to 10
...
void loop() {
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  if (fed3.FEDmode == 2) {
    fed3.sessiontype = "RandRatio5";                  //The text in "sessiontype" will appear on the screen and in the logfile
    if (fed3.Left) {
      currentPokeCount ++;
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  if (fed3.FEDmode == 3) {
    fed3.sessiontype = "RandRatio10";                 //The text in "sessiontype" will appear on the screen and in the logfile
    if (fed3.Left) {
      currentPokeCount ++;
      fed3.Click();                                     //click stimulus
      fed3.logLeftPoke();                               //Log left poke
      if (LeftActive == true) {
        if (currentPokeCount % FR1to10 == 0) {                 //if fixed ratio is  met
          fed3.ConditionedStimulus();                   //deliver conditioned stimulus (tone and lights)
          fed3.Feed();                                  //deliver pellet
          FR1to10 = random(1, 11);                           //Pick a random number between 1 and 10 to be the FR
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  if (fed3.FEDmode == 4) {
    fed3.sessiontype = "RandRatio20";                 //The text in "sessiontype" will appear on the screen and in the logfile
    if (fed3.Left) {
      currentPokeCount ++;
      fed3.Click();                                     //click stimulus
      fed3.logLeftPoke();                               //Log left poke
      if (LeftActive == true) {
        if (currentPokeCount % FR1to20 == 0) {                 //if fixed ratio is  met
          fed3.ConditionedStimulus();                   //deliver conditioned stimulus (tone and lights)
          fed3.Feed();                                  //deliver pellet
          FR1to20 = random(1, 21);                           //Pick a random number between 1 and 20 to be the FR
